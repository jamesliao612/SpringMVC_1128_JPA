        ...
        <script>
            $(document).ready(function () {
                $("#myTable").on("click", "tr", function () {
                    ...
                    //console.log(id);
                    $.get("/SpringMVC_1128_JPA/mvc/portfolio/classify/" + id, function (data, status) {
                ...
                $("#add").on("click", function () {
                    ...
                    $.ajax({
                        url: "/SpringMVC_1128_JPA/mvc/portfolio/classify/",
                        type: "POST",
                ...
                $("#upt").on("click", function () {
                    ...
                    var jsonStr = JSON.stringify(jsonObj);
                    $.ajax({
                        url: "/SpringMVC_1128_JPA/mvc/portfolio/classify/" + jsonObj.id,
                        type: "PUT",
                        contentType: "application/json; charset=utf-8",
                        data: jsonStr,
                        async: true, 
                ...
                $("#del").on("click", function () {
                    ...
                    $.ajax({
                        url: "/SpringMVC_1128_JPA/mvc/portfolio/classify/" + id,
                        type: "DELETE",
                        async: true,
                        cache: false,
                        processData: false,
            ...
            function table_list() {
                $.get("/SpringMVC_1128_JPA/mvc/portfolio/classify/", function (datas, status) {
                        ...
                        <div class="content">
                            <form id="myform" class="pure-form">
                                <fieldset>
                                    ...
                                    <button id="del" type="button" class="pure-button pure-button-primary">刪除</button><p />
                                    <button type="reset" class="pure-button pure-button-primary">重設</button>
