        ...
        <script>
            $(document).ready(function () {
                $("#myTable").on("click", "tr", function () {
                    ...
                    //console.log(id);
                    $.get("/SpringMVC_1128_JPA/mvc/portfolio/investor/" + id, function (data, status) {
                ...
                $("#add").on("click", function () {
                    ...
                    $.ajax({
                        url: "/SpringMVC_1128_JPA/mvc/portfolio/investor/",
                        type: "POST",
                ...
                $("#upt").on("click", function () {
                    ...
                    var jsonStr = JSON.stringify(jsonObj);
                    $.ajax({
                        url: "/SpringMVC_1128_JPA/mvc/portfolio/investor/" + jsonObj.id,
                        type: "PUT",
                        contentType: "application/json; charset=utf-8",
                        data: jsonStr,
                        async: true, 
                ...
                $("#del").on("click", function () {
                    ...
                    $.ajax({
                        url: "/SpringMVC_1128_JPA/mvc/portfolio/investor/" + id,
                        type: "DELETE",
                        async: true,
                        cache: false,
                        processData: false,
            ...
            function table_list() {
                $.get("/SpringMVC_1128_JPA/mvc/portfolio/investor/", function (datas, status) {
