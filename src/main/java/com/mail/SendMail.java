 ...
 * </dependency>
 * 2. Google 二階段驗證啟用
 * https://www.google.com/landing/2step/?utm_source=pp&hl=zh_TW
 * 3. 申請應用程式密碼
...
public class SendMail {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String to = "gamer20171012@gmail.com"; // 發送給誰 ? 若有多筆", "號隔開
    ...
    public void submit(String personal, String to, String title, String html) throws Exception {
        ...
        final String googleGmail = "gamer20171012@gmail.com"; // 你的 Gmail
        final String authPassword = "ocmegpfevwxfiyhs"; // 授權碼
